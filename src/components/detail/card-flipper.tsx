...
export function CardFlipper({ dish, ingredients, coverImage, className }: CardFlipperProps) {
  ...
  return (
    <div
      className={cn("relative h-72 w-full cursor-pointer perspective-distant", className)}
    ...
    >
      ...
      >
        {/* 앞면 — 음식 정보 */}
        <div className="bg-mocha-50 absolute inset-0 overflow-hidden rounded-2xl backface-hidden">
          <div className="flex h-full flex-col items-center justify-center gap-4 px-6">
            {coverImage ? (
              <div className="shadow-card relative h-40 w-full overflow-hidden rounded-2xl">
                <Image
                  src={coverImage}
                  alt={dish.name}
                  fill
        ...
        {/* 뒷면 — 재료 목록 */}
        <div className="absolute inset-0 transform-[rotateY(180deg)] overflow-hidden rounded-2xl bg-white backface-hidden">
