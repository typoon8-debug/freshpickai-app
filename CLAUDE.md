...
우리가족을 위한 AI 큐레이팅 장보기 — 다양한 테마 카드(흑백요리사·제철 K-팜·홈시네마 등)로 메뉴를 고르고, AI에게 변형을 요청하고, 가족과 투표한 뒤, 재료를 한꺼번에 장바구니에 담아 바로바로 배송 받는 모바일 커머스. 배송은 스토어 배송정책에 따라 다양한 방식으로 제공됨 (sellerbox-app 정책).
